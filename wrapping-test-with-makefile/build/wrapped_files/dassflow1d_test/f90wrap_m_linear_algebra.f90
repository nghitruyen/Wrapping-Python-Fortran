...
subroutine f90wrap_matrixcsr_initialise(mat, n, nnz)
    use m_linear_algebra, only: matrixcsr, matrixcsr_initialise
    implicit none
...
subroutine f90wrap_csr_x_vec_add(a, x, y, n0, n1)
    use m_linear_algebra, only: matrixcsr, csr_x_vec_add
    implicit none
...
subroutine f90wrap_matrixblock__array_getitem__blocks(f90wrap_this, f90wrap_i, blocksitem)
...
subroutine f90wrap_matrixblock__array_setitem__blocks(f90wrap_this, f90wrap_i, blocksitem)
...
subroutine f90wrap_matrixblock_initialise(mat, n, sizes, n0)
    use m_linear_algebra, only: matrixblock_initialise, matrixblock
    implicit none
...
subroutine f90wrap_matrixcsr_from_matrixblock(matblock, matcsr, threshold)
    use m_linear_algebra, only: matrixcsr, matrixcsr_from_matrixblock, matrixblock
    implicit none
    ...
    call matrixcsr_from_matrixblock(matblock=matblock_ptr%p, matcsr=matcsr_ptr%p, threshold=threshold)
